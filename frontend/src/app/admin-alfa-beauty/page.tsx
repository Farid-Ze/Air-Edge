...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] flex flex-col font-sans select-none relative overflow-hidden">
      ...
      {/* Signature Brand Header (Compact & Professional for Admin) */}
      ...
      {/* Main Content Area */}
      <main className="relative z-10 flex-1 px-3 sm:px-6 md:px-8 pt-0 -mt-4 sm:-mt-8 md:-mt-12 lg:-mt-16 pb-8 md:pb-10 max-w-[1600px] w-full mx-auto">
        
        {/* Title & Action Buttons Row */}
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-4 sm:gap-5 mb-6 sm:mb-8 pb-4 sm:pb-6 border-b border-gray-200/60">
          <div>
            <div className="flex items-center gap-2 mb-1.5 sm:mb-2">
              <span className="inline-block px-2.5 py-0.5 sm:px-3 sm:py-1 bg-[#111111] text-white text-[9px] sm:text-[10px] font-bold tracking-[0.2em] uppercase rounded-md">
                ADMIN DASHBOARD
              </span>
            ...
            <h1 className="text-xl sm:text-3xl lg:text-4xl font-black text-[#111111] uppercase tracking-tight">
          ...
          {/* Action Buttons */}
          <div className="grid grid-cols-2 sm:flex sm:flex-row sm:items-center sm:gap-2.5 gap-2 w-full sm:w-auto shrink-0">
            <button
              onClick={openAddModal}
              className="inline-flex items-center justify-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2.5 bg-[#111111] hover:bg-black text-white text-[10px] sm:text-[11px] font-bold uppercase tracking-wider rounded-xl shadow-md transition-all active:scale-[0.98] cursor-pointer whitespace-nowrap"
            >
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2.5 border border-gray-200/90 bg-white hover:border-[#111111] text-[#111111] text-[10px] sm:text-[11px] font-bold uppercase tracking-wider rounded-xl transition-all shadow-2xs disabled:opacity-40 cursor-pointer whitespace-nowrap"
            >
            ...
            <Link
              href="/admin-alfa-beauty/scanner"
              className="inline-flex items-center justify-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2.5 bg-white border border-gray-200/90 hover:border-[#111111] text-[#111111] text-[10px] sm:text-[11px] font-bold uppercase tracking-wider rounded-xl shadow-2xs transition-all active:scale-[0.98] whitespace-nowrap"
            >
              <svg className="w-3.5 h-3.5 shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        {/* Editorial Stat Cards Grid: 3 Columns across all screens */}
        <div className="grid grid-cols-3 gap-2.5 sm:gap-5 mb-6 sm:mb-8">
          <div className="bg-white rounded-2xl p-2.5 sm:p-6 border border-gray-200/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] flex flex-col justify-between">
            <p className="text-[8px] sm:text-[10px] font-bold text-gray-400 uppercase tracking-wider sm:tracking-widest truncate">
              PENDAFTAR
            </p>
            <p className="text-lg sm:text-3xl md:text-4xl font-black text-[#111111] mt-0.5 sm:mt-2">
          ...
          <div className="bg-white rounded-2xl p-2.5 sm:p-6 border border-gray-200/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] flex flex-col justify-between">
            ...
            <p className="text-lg sm:text-3xl md:text-4xl font-black text-emerald-600 mt-0.5 sm:mt-2">
          ...
          <div className="bg-white rounded-2xl p-2.5 sm:p-6 border border-gray-200/80 shadow-[0_8px_30px_rgba(0,0,0,0.03)] flex flex-col justify-between">
            ...
            <p className="text-lg sm:text-3xl md:text-4xl font-black text-[#D86B6B] mt-0.5 sm:mt-2">
              {stats.attendance_rate}%
            </p>
            {/* Sleek Progress Bar */}
            <div className="mt-1 sm:mt-3 h-1.5 sm:h-2 bg-gray-100 rounded-full overflow-hidden">
              <div
        ...
        <div className="bg-white rounded-2xl border border-gray-200/90 shadow-[0_12px_40px_rgba(0,0,0,0.04)] overflow-hidden">
          ...
          {/* Search Bar */}
          <div className="p-3 sm:p-6 border-b border-gray-100 bg-[#FAFAFA]">
            <div className="relative max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 sm:py-3 bg-white border border-gray-200 rounded-xl text-xs font-medium text-[#111111] placeholder-gray-400 focus:border-[#111111] focus:outline-none transition-colors shadow-2xs"
              />
            </div>
          </div>

          {/* Participants Display Area (Mobile Cards + Desktop Table) */}
          <div>
            {error ? (
              ...
              <>
                ...
                <div className="block md:hidden divide-y divide-gray-100">
                  {participants.map((p, idx) => (
                    <div key={p.id} className="p-4 space-y-2.5 hover:bg-gray-50/80 transition-colors">
                      {/* Top Bar: No, ID & Status Toggle */}
                      <div className="flex items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                          <span className="text-[11px] font-mono text-gray-400 font-bold">
                            #{(page - 1) * 20 + idx + 1}
                          </span>
                          <span className="text-[10px] font-mono text-gray-600 bg-gray-100 px-2 py-0.5 rounded-md font-semibold">
                            ID: {p.ticket_id.slice(0, 8)}...
                          </span>
                        </div>
                        <button
                        ...
                        >
                          {p.is_attended ? (
                            ...
                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold uppercase bg-gray-100 text-gray-500 border border-gray-200">
                      ...
                      <div>
                        <p className="font-bold text-[#111111] text-sm">{p.name}</p>
      ...
      {isAddOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl border border-gray-100">
            <h2 className="text-xl font-black text-[#111111] uppercase tracking-tight mb-1">
              Tambah Peserta Baru
            </h2>
            <p className="text-xs text-gray-400 mb-6 font-medium">
              Isi data peserta untuk menerbitkan tiket baru.
            </p>
            ...
            <form onSubmit={handleAddSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-medium focus:border-[#111111] focus:outline-none transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Nama Salon / Instansi (Opsional)"
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-xs font-medium focus:border-[#111111] focus:outline-none transition-colors"
                />
              </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                <button
                  ...
                  className="px-4 py-2.5 text-xs font-bold text-gray-500 hover:text-black transition-colors cursor-pointer"
                >
                  Batal
                </button>
                <button
                  ...
                  className="px-5 py-2.5 bg-[#111111] text-white text-xs font-bold uppercase tracking-widest rounded-xl hover:bg-black transition-colors disabled:opacity-50 cursor-pointer"
                >
      ...
      {editingParticipant && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl border border-gray-100">
            ...
            <p className="text-xs text-gray-400 mb-6 font-medium font-mono">
            ...
            <form onSubmit={handleEditSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-[#111111] text-white text-xs font-bold uppercase tracking-widest rounded-xl hover:bg-black transition-colors disabled:opacity-50 cursor-pointer"
                >
                  {modalLoading ? "Memperbarui..." : "Update Peserta"}
                </button>
              </div>
            </form>
          </div>
      ...
      {deletingParticipant && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
          <div className="bg-white rounded-3xl max-w-sm w-full p-6 sm:p-8 shadow-2xl border border-gray-100 text-center">
            ...
            <h2 className="text-lg font-black text-[#111111] uppercase tracking-tight mb-2">
              Hapus Peserta Ini?
            </h2>
            <p className="text-xs text-gray-500 mb-6 font-medium">
              Apakah Anda yakin ingin menghapus <strong>{deletingParticipant.name}</strong>? Tindakan ini tidak dapat dibatalkan.
            </p>
            ...
            <div className="flex items-center justify-center gap-3">
              <button
                ...
                className="w-1/2 py-2.5 text-xs font-bold text-gray-500 hover:text-black border border-gray-200 rounded-xl transition-colors cursor-pointer"
              >
                Batal
              </button>
              <button
                ...
                disabled={modalLoading}
                className="w-1/2 py-2.5 bg-red-600 hover:bg-red-700 text-white text-xs font-bold uppercase tracking-wider rounded-xl transition-colors disabled:opacity-50 cursor-pointer"
              >
