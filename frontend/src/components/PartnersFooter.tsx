    ...
    <footer className="relative py-20 px-6 border-t border-gray-200 bg-[#F9F9FA] overflow-hidden">
      <div className="relative max-w-6xl mx-auto z-10">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 text-center lg:text-left">
          ...
          {/* Direct Contact & Social CTAs: Neat Single Row */}
          <div className="flex flex-wrap items-center justify-center lg:justify-end gap-2.5">
            <a
              href="tel:+6281511688745"
              className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-4 sm:py-3 border border-gray-300 bg-white text-[10px] font-bold text-[#111111] tracking-widest uppercase hover:border-[#111111] hover:bg-gray-50 rounded-xl transition-all duration-300 shadow-xs whitespace-nowrap"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-4 sm:py-3 bg-[#25D366] hover:bg-[#20bd5a] text-white text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all duration-300 shadow-[0_4px_15px_rgba(37,211,102,0.25)] hover:scale-102 whitespace-nowrap"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2.5 sm:px-4 sm:py-3 bg-black hover:bg-gray-800 text-white text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all duration-300 shadow-md hover:scale-102 whitespace-nowrap"
            >
