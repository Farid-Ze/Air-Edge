    ...
    <footer className="relative py-20 px-6 border-t border-gray-200 bg-[#F9F9FA] overflow-hidden">
      <div className="relative max-w-6xl mx-auto z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 text-center lg:text-left">
          ...
          {/* Direct Contact & Social CTAs */}
          <div className="flex flex-wrap items-center justify-center gap-3">
            <a
              href="tel:+6281511688745"
              className="inline-flex items-center gap-2 px-5 py-3.5 border border-gray-300 bg-white text-[10px] font-bold text-[#111111] tracking-widest uppercase hover:border-[#111111] hover:bg-gray-50 rounded-xl transition-all duration-300 shadow-sm"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-3.5 bg-[#25D366] hover:bg-[#20bd5a] text-white text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all duration-300 shadow-[0_4px_15px_rgba(37,211,102,0.3)] hover:scale-105"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-3.5 bg-black hover:bg-gray-800 text-white text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all duration-300 shadow-md hover:scale-105"
            >
