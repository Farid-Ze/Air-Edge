    ...
    <footer className="relative py-20 px-6 border-t border-gray-200 bg-[#F9F9FA] overflow-hidden">
      <div className="relative max-w-6xl mx-auto z-10">
        ...
        <div className="mb-20">
          ...
          {/* 2x2 Symmetrical Grid on Mobile, Flex Row on Desktop */}
          <div className="grid grid-cols-2 md:flex items-center justify-center gap-6 sm:gap-8 md:gap-16 max-w-5xl mx-auto">
            {partners.map((partner) => (
              <div
                key={partner.name}
                className="group relative flex items-center justify-center p-3 hover:-translate-y-1 transition-transform duration-300 bg-white/50 md:bg-transparent rounded-xl border border-gray-100/80 md:border-none shadow-2xs md:shadow-none"
              >
                <Image
                  src={partner.logo}
                  alt={partner.name}
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 text-center lg:text-left">
          ...
          {/* Direct Contact & Social CTAs: 100% Equal Width Stack on Mobile, Flex Row on Desktop */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center lg:justify-end gap-2.5 w-full sm:w-auto">
            <a
              href="tel:+6281511688745"
              className="inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-4 sm:py-3 border border-gray-300 bg-white text-[10px] font-bold text-[#111111] tracking-widest uppercase hover:border-[#111111] hover:bg-gray-50 rounded-xl transition-all duration-300 shadow-xs whitespace-nowrap w-full sm:w-auto text-center"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-4 sm:py-3 bg-[#25D366] hover:bg-[#20bd5a] text-white text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all duration-300 shadow-[0_4px_15px_rgba(37,211,102,0.25)] hover:scale-102 whitespace-nowrap w-full sm:w-auto text-center"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-3 sm:px-4 sm:py-3 bg-black hover:bg-gray-800 text-white text-[10px] font-bold tracking-widest uppercase rounded-xl transition-all duration-300 shadow-md hover:scale-102 whitespace-nowrap w-full sm:w-auto text-center"
            >
